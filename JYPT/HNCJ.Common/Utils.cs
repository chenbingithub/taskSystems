...
namespace HNCJ.Common
{
    public class Utils
    {
        ...
        /// <returns></returns>
        public static string OrderInfoStatus(int id)
        {
            string str = "";
            switch (id)
            {
                ...
                case 4: str = "已确认收货"; break;
                case 5: str = "待评价"; break;
                case 6: str = "交易成功"; break;
                case 7: str = "退款中"; break;
                case 8: str = "退款成功"; break;
                case 9: str = "交易关闭"; break;
                default: str = "交易关闭"; break;
            }
            return str;
        } 
        #endregion
        public static String IntToStr(short value)
        {
            if (value == 1) return "一般";
            else if (value == 2) return "紧急";
            else if (value == 3) return "急需办";
            else return "其他";
        }
        ...
        #region 对象转换处理
        public static String ShortToStr(short? value)
        {
            return value == 1 ? "待审批..." : "已审核";
        }
        /// <summary>
        /// 判断对象是否为Int32类型的数字
        /// </summary>
        ...
        /// <returns>List<int>集合</returns>
        public static List<int> GetStrList(string str) {
            string[] ids = GetStrArray(str);
        ...
        public static string GetOrderNumber()
        {
            ...
            return num + Number(4, true).ToString();
        }
