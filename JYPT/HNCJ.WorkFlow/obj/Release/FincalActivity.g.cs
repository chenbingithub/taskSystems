...
namespace HNCJ.OA.WorkFlow {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class FincalActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(FincalActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(FincalActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(FincalActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".FincalActivity.g.xaml") || resource.Equals("FincalActivity.g.xaml"))) {
                    return resource;
                }
            }
